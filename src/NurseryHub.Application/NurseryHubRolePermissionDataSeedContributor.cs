...
public class NurseryHubRolePermissionDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    public async Task SeedAsync(DataSeedContext context)
    {
        ...
        var permissions = new List<string>
        {
            ...
            NurseryHubPermissions.StudentApplications.Default,
            NurseryHubPermissions.StudentApplications.Create,
            NurseryHubPermissions.StudentApplications.Edit,
            NurseryHubPermissions.StudentApplications.Delete,
            ...
            NurseryHubPermissions.NurseryClasses.Default,
            NurseryHubPermissions.NurseryClasses.Create,
            NurseryHubPermissions.NurseryClasses.Edit,
            NurseryHubPermissions.NurseryClasses.Delete,
            NurseryHubPermissions.Notifications.Default,
            NurseryHubPermissions.Notifications.Create,
            NurseryHubPermissions.Notifications.Edit,
            NurseryHubPermissions.Notifications.Delete,
            NurseryHubPermissions.Notifications.Send,
        };
