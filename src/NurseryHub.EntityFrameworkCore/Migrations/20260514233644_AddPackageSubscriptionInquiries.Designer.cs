...
namespace NurseryHub.Migrations
{
    ...
    [Migration("20260514233644_AddPackageSubscriptionInquiries")]
    partial class AddPackageSubscriptionInquiries
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NurseryHub.Locations.City", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("NurseryHub.Locations.Governorate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NurseryHub.Nurseries.Attendance", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NurseryHub.Nurseries.DailyFollowupActivityEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("DailyFollowupBookId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DailyFollowupBookId", "ActivityType")
                        .IsUnique();

                    b.ToTable("AppDailyFollowupActivityEntries", (string)null);
                });

            modelBuilder.Entity("NurseryHub.Nurseries.DailyFollowupBook", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int?>("MoodAfterWaking")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("SentToParentAt")
                        .HasColumnType("datetime2");

                    b.Property<string>("SleepDuration")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");

                    b.Property<bool>("SleptToday")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("TenantId", "NurseryBranchId", "ReportDate");

                    b.ToTable("AppDailyFollowupBooks", (string)null);
                });

            modelBuilder.Entity("NurseryHub.Nurseries.DailyFollowupMealEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DailyFollowupBookId", "MealType")
                        .IsUnique();

                    b.ToTable("AppDailyFollowupMealEntries", (string)null);
                });

            modelBuilder.Entity("NurseryHub.Nurseries.DailyFollowupSubjectEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DailyFollowupBookId", "SortOrder");

                    b.ToTable("AppDailyFollowupSubjectEntries", (string)null);
                });

            modelBuilder.Entity("NurseryHub.Nurseries.Expense", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("CustomExpenseCategory")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
                    ...
                    b.HasIndex("TenantId", "ExpenseCategory");
                    ...
                    b.HasIndex("TenantId", "NurseryBranchId", "ExpenseDate");

                    b.ToTable("AppExpenses", (string)null);
                });

            modelBuilder.Entity("NurseryHub.Nurseries.GradeCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "NurseryBranchId", "Name")
                        .IsUnique()
                        .HasFilter("[TenantId] IS NOT NULL");

                    b.ToTable("AppGradeCategories", (string)null);
                });

            modelBuilder.Entity("NurseryHub.Nurseries.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NurseryHub.Nurseries.NotificationRecipient", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("NotificationId", "ParentUserId")
                        .IsUnique();

                    b.HasIndex("TenantId", "DeliveryStatus");

                    b.ToTable("AppNotificationRecipients", (string)null);
                });

            modelBuilder.Entity("NurseryHub.Nurseries.Nursery", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppNurseries", (string)null);
                });

            modelBuilder.Entity("NurseryHub.Nurseries.NurseryBranch", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("IsTransportationIncluded")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("TenantId", "GovernorateId", "CityId");

                    b.HasIndex("TenantId", "NurseryId", "Name");

                    b.ToTable("AppNurseryBranches", (string)null);
                });

            modelBuilder.Entity("NurseryHub.Nurseries.NurseryClass", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "GradeCategoryId");

                    b.HasIndex("TenantId", "NurseryBranchId", "Name");

                    b.ToTable("AppNurseryClasses", (string)null);
                });

            modelBuilder.Entity("NurseryHub.Nurseries.ParentContact", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("FatherIdentityNumber")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.ToTable("AppParentContacts", (string)null);
                });

            modelBuilder.Entity("NurseryHub.Nurseries.ParentStudent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "ParentUserId");

                    b.HasIndex("TenantId", "StudentId");

                    b.HasIndex("TenantId", "ParentUserId", "StudentId")
                        .IsUnique()
                        .HasFilter("[TenantId] IS NOT NULL");

                    b.ToTable("AppParentStudents", (string)null);
                });

            modelBuilder.Entity("NurseryHub.Nurseries.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("CustomPaymentPurpose")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
            ...
            modelBuilder.Entity("NurseryHub.Nurseries.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("AttendsFriday")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("AttendsMonday")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("AttendsSaturday")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("AttendsSunday")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("AttendsThursday")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("AttendsTuesday")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("AttendsWednesday")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
                    ...
                    b.Property<Guid?>("NurseryClassId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ToiletTrainingStatus")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.HasIndex("TenantId", "NurseryClassId");
            ...
            modelBuilder.Entity("NurseryHub.Nurseries.UserBranch", b =>
                {
                    ...
                    b.HasIndex("TenantId", "NurseryBranchId");

                    b.HasIndex("TenantId", "UserId", "NurseryBranchId")
                        .IsUnique()
                        .HasFilter("[TenantId] IS NOT NULL");

                    b.ToTable("AppUserBranches", (string)null);
                });

            modelBuilder.Entity("NurseryHub.Portal.PackageSubscriptionInquiry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PackageTier");

                    b.ToTable("AppPackageSubscriptionInquiries", (string)null);
                });
            ...
            modelBuilder.Entity("NurseryHub.Locations.City", b =>
                {
                    b.HasOne("NurseryHub.Locations.Governorate", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NurseryHub.Nurseries.Attendance", b =>
                {
                    b.HasOne("NurseryHub.Nurseries.Student", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NurseryHub.Nurseries.DailyFollowupActivityEntry", b =>
                {
                    b.HasOne("NurseryHub.Nurseries.DailyFollowupBook", null)
                        .WithMany("Activities")
                        .HasForeignKey("DailyFollowupBookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("NurseryHub.Nurseries.NotificationRecipient", b =>
                {
                    b.HasOne("NurseryHub.Nurseries.Notification", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NurseryHub.Nurseries.NurseryBranch", b =>
                {
                    b.HasOne("NurseryHub.Locations.City", null)
                        .WithMany()
                    ...
                    b.HasOne("NurseryHub.Nurseries.Nursery", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NurseryHub.Nurseries.Payment", b =>
                {
                    b.HasOne("NurseryHub.Nurseries.NurseryClass", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NurseryHub.Nurseries.Student", b =>
                {
                    ...
                    b.HasOne("NurseryHub.Nurseries.ParentContact", "Parent")
                        .WithMany()
